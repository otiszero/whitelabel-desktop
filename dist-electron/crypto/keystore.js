 ...
 */
export async function createKeystore(mnemonic, password, wallets = []) {
 ...
 */
export async function updateKeystoreWallets(keystore, password, wallets) {
 ...
 */
export async function verifyPassword(keystore, password) {
    try {
